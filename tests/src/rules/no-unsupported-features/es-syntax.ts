      ...
      invalid: [
        {
          ...
          errors: [{ ...error('no-modules', '13.2.0', '10.0.0'), type: AST_NODE_TYPES.ImportDeclaration }],
        },
        {
          code: 'export default {}',
          parserOptions: { sourceType: 'module' },
          options: [{ version: '10.0.0' }],
          errors: [{ ...error('no-modules', '13.2.0', '10.0.0'), type: AST_NODE_TYPES.ExportDefaultDeclaration }],
        },
        {
          code: 'export const a = {}',
          parserOptions: { sourceType: 'module' },
          options: [{ version: '10.0.0' }],
          errors: [{ ...error('no-modules', '13.2.0', '10.0.0'), type: AST_NODE_TYPES.ExportNamedDeclaration }],
        },
        {
          code: 'export {}',
          parserOptions: { sourceType: 'module' },
