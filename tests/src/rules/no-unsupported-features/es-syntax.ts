  ...
  concat([
    ...
    },
    {
      ...
      valid: [
        ...
        { code: "import a from 'a'", parserOptions: { sourceType: 'module' }, options: [{ version: '13.2.0' }] },
        { code: 'export default {}', parserOptions: { sourceType: 'module' }, options: [{ version: '13.2.0' }] },
        { code: 'export const a = {}', parserOptions: { sourceType: 'module' }, options: [{ version: '13.2.0' }] },
        { code: 'export {}', parserOptions: { sourceType: 'module' }, options: [{ version: '13.2.0' }] },
      ],
      invalid: [
        {
          code: "import a from 'a'",
          ...
          errors: [{ ...error('no-modules', '13.2.0', '13.1.0'), type: AST_NODE_TYPES.ImportDeclaration }],
        },
        {
          code: 'export default {}',
          parserOptions: { sourceType: 'module' },
          options: [{ version: '13.1.0' }],
          errors: [{ ...error('no-modules', '13.2.0', '13.1.0'), type: AST_NODE_TYPES.ExportDefaultDeclaration }],
        },
        {
          code: 'export const a = {}',
          parserOptions: { sourceType: 'module' },
          options: [{ version: '13.1.0' }],
          errors: [{ ...error('no-modules', '13.2.0', '13.1.0'), type: AST_NODE_TYPES.ExportNamedDeclaration }],
        },
        {
          code: 'export {}',
          parserOptions: { sourceType: 'module' },
