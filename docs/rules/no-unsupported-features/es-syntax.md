# node-roikoren/no-unsupported-features/es-syntax
...
- [Rule source](https://github.com/roikoren755/eslint-plugin-node/blob/v3.0.4/src/rules/no-unsupported-features/es-syntax.ts)
- [Test source](https://github.com/roikoren755/eslint-plugin-node/blob/v3.0.4/tests/src/rules/no-unsupported-features/es-syntax.ts)
