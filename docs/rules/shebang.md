...
- [Rule source](https://github.com/roikoren755/eslint-plugin-node/blob/v2.0.0/src/rules/shebang.ts)
- [Test source](https://github.com/roikoren755/eslint-plugin-node/blob/v2.0.0/tests/src/rules/shebang.ts)
